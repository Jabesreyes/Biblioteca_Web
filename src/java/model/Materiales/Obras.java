...
public class Obras {
    ...
    public Obras(String codigoidentificacion, String titulo, String autor, int paginas, String genero, String fechapublicacion, String ubicacion, int unidades, int unidadesprestados, int unidadesdisponibles) {
